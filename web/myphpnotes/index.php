        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="panel">
                    ...
                    <br><br><hr><br>
                    <p style="font-size: 80%; text-align: center; ">Brought to you by 
                    <a href="https://youtube.com/myPHPnotes">myPHPnotes</a> | 
                    <a href="https://www.myphpnotes.tk">Learn How I Made This</a></p>
                </div>
            </div>
        </div>
    </div>
